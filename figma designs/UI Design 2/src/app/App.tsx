...
export default function App() {
  ...
  const myDashboardItems = [
    ...
    { id: 'leaves', label: 'Leaves and Holidays', icon: Calendar },
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            ...
            {activeSection === 'my-team' && <MyTeamManager />}
            {activeSection === 'my-todo' && <MyToDo />}
            {activeSection === 'leaves' && <Leaves />}
            {activeSection === 'claims' && <Claims />}
            {activeSection === 'policies' && <Policies isAdmin={true} />}
            {activeSection === 'settings' && <SettingsComponent />}
            {activeSection === 'employees' && <Employees />}
            {activeSection === 'administration' && <Administration />}
            {activeSection !== 'home' && activeSection !== 'notice-board' && activeSection !== 'my-team' && activeSection !== 'my-todo' && activeSection !== 'leaves' && activeSection !== 'claims' && activeSection !== 'policies' && activeSection !== 'settings' && activeSection !== 'employees' && activeSection !== 'administration' && <AdminDashboard />}
          </div>
        </div>
      </main>
    </div>
